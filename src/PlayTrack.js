...
class PlayTrack extends React.Component {
  ...
  getSong() {
    ...
    const url = `http://localhost:8000/songs/${randomNumber}/`
    fetch(url)
      ...
      <div>
        {
          this.state.loadedCharacter && 
            <div>
              ...
              <audio id="audio1" src={this.state.file} preload="auto" autoPlay controls controlsList="nodownload noplaybackrate"/>
